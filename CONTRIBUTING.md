...
### 进阶任务 (`help wanted`)
- 增加更多情绪支持，包含静态表情绘制、动态表情动画等多种情绪集成，实现更多样化的情绪识别
...
- 增强AI扩展卡片的展示页面，实现动态表情展示、置信度展示、多种情绪组合展示等高级功能，让用户更直观地理解AI分析结果
- 设计并实现日间模式，提供浅/深色主题切换、自动按时间段切换主题以及不同主题下的背景切换等功能，提升用户体验
